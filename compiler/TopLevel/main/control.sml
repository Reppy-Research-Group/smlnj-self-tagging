...
structure Control_CG : CGCONTROL =
  struct
    ...
    val selfTagReals = new (b, "self-tag-reals", "enable self-tagging for reals types", false)
    val selfTagInts = new (b, "self-tag-ints", "enable self-tagging for integers and words", true)
